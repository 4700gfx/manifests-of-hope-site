    ...
    <section className='flex flex-col px-4 sm:px-6 lg:px-8 py-14 lg:py-14'>
      <div className="mx-auto w-11/12 max-w-7xl">
        ...
        <div className="text-center mt-16">
          <button className="group bg-hope-platinum text-hope-aquablue px-10 py-4 rounded-full font-bold font-belleza text-xl hover:bg-white transform hover:scale-105 hover:-translate-y-1 transition-all duration-300 ease-in-out relative overflow-hidden">
