...
const JourneyCards = () => {
  ...
  return (
    <section className='flex flex-col px-4 sm:px-6 lg:px-8 py-14 lg:py-14' id='journeyCard'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8'>
          {journeyCards.map((card, index) => (
            <Link 
              ...
              className="block"
            >
              <div className="group relative h-80 sm:h-96 rounded-3xl overflow-hidden cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-2">
                {/* Background Image */}
